...
public class SOCOM(
    ...
    TimeUtil timeUtil,
    SOCOMTraderHelper traderHelper
)
    : IOnLoad
{
    ...
    public Task OnLoad()
    {
        ...
        var traderImagePath = Path.Combine(pathToMod, "res/socom.png");
        ...
        traderHelper.AddTraderToLocales(traderBase, "SOCOM", "DevGru SOCOM JSOC Armory");

        // Get the assort data from JSON
        var assort = modHelper.GetJsonDataFromFile<TraderAssort>(pathToMod, "db/TraderSOCOM/assort.json");
